...
import { Building2, Calendar, Check, ChevronDown, Copy, Download, Plane, Plus, Search, SlidersHorizontal, User, X } from 'lucide-react';
  ...
  return (
    <>
      ...
      <datalist id="airline-suggestions">
        ...
        {AIRLINE_CODES.map((a) => <option key={`a-${a.iata}`} value={a.iata} label={`${a.iata} â€” ${a.name}`} />)}
      </datalist>
