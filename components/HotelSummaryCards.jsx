  ...
  return (
    <div className="flex overflow-x-auto gap-2 sm:gap-3 mb-6 pb-1 -mx-4 px-4 sm:mx-0 sm:px-0 snap-x snap-mandatory scrollbar-none">
      <div className="bg-white rounded-2xl border border-stone-200 p-2.5 sm:p-4 flex items-center gap-2 sm:gap-3 shrink-0 snap-start basis-[42%] sm:basis-0 sm:flex-1">
        ...
        <div className="min-w-0"><p className="text-xs text-stone-500 whitespace-nowrap">Bookings</p><p className="text-sm sm:text-lg font-bold whitespace-nowrap">{totals.count}</p></div>
      </div>
      <div className="bg-white rounded-2xl border border-stone-200 p-2.5 sm:p-4 flex items-center gap-2 sm:gap-3 shrink-0 snap-start basis-[42%] sm:basis-0 sm:flex-1">
        ...
        <div className="min-w-0"><p className="text-xs text-stone-500 whitespace-nowrap">Total sales (EGP)</p><p className="text-sm sm:text-lg font-bold whitespace-nowrap">{formatNumber(totals.sold)}</p></div>
      </div>
      <div className="bg-white rounded-2xl border border-stone-200 p-2.5 sm:p-4 flex items-center gap-2 sm:gap-3 shrink-0 snap-start basis-[42%] sm:basis-0 sm:flex-1">
        ...
        <div className="min-w-0"><p className="text-xs text-stone-500 whitespace-nowrap">Total profit (EGP)</p><p className="text-sm sm:text-lg font-bold text-emerald-700 whitespace-nowrap">{formatNumber(totals.profit)}</p></div>
      </div>
    </div>
  );
}
